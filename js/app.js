...
dropdownArrowBackground.addEventListener('click', () => {
    ...
    popUpDiv.innerHTML = `<div id='pop-up-box'>
                            ...
                            <p>I look forward to working in a team-oriented, fun, and challenging workplace environment. If I sound like a good fit for your team, please add me to your contacts list and feel free to shoot me a message below!</p>
                        </div>`;
